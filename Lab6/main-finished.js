...
// Set Ball prototype to inherit from Shape prototype
...
// Set EvilCircle prototype to inherit from Shape prototype
...
function loop() {
  ...
  // Count and display remaining balls
  let ballCount = balls.filter(ball => ball.exists).length;
  ballCountDisplay.textContent = 'Ball count: ' + ballCount;

  requestAnimationFrame(loop);
}

// Add ball count display to HTML

const ballCountDisplay = document.createElement('p');
ballCountDisplay.id = 'ball-count';
